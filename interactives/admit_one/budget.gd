...
func _ready() -> void:
	set_thing("academics")
	var vbc = "CenterContainer/HBoxContainer/PanelContainer/GridContainer/"
...
func set_thing(thing):
	...
	get_node("CenterContainer/HBoxContainer/VBoxContainer2/HBoxContainer/department").text = get_node("CenterContainer/HBoxContainer/PanelContainer/GridContainer/"+thing).text

func _process(delta: float) -> void:
	get_node("CenterContainer2/PanelContainer/HBoxContainer3/tbudget").text = "$" + str(main.real_budget())
